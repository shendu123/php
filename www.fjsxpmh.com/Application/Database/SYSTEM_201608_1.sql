...
# Type: 系统自动备份
# Description:当前SQL文件包含了表：on_access、on_admin、on_advertising、on_advertising_position、on_attention、on_attention_seller、on_auction、on_auction_agency、on_auction_pledge、on_auction_record、on_category、on_deliver_address、on_express、on_feedback、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_evaluate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_meeting_auction、on_member、on_member_evaluate、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_member_weixin、on_mysms、on_navigation、on_news、on_node、on_payorder、on_region、on_role、on_role_user、on_seller_pledge、on_share、on_special_auction、on_verify_email、on_verify_mobile、on_weiurl的结构信息，表：on_access、on_admin、on_advertising、on_advertising_position、on_attention、on_attention_seller、on_auction、on_auction_agency、on_auction_pledge、on_auction_record、on_category、on_deliver_address、on_express、on_feedback、on_goods、on_goods_category、on_goods_category_extend、on_goods_category_filtrate、on_goods_evaluate、on_goods_extend、on_goods_fields、on_goods_filtrate、on_goods_order、on_goods_user、on_link、on_meeting_auction、on_member、on_member_evaluate、on_member_limsum_bill、on_member_pledge_bill、on_member_pledge_take、on_member_weixin、on_mysms、on_navigation、on_news、on_node、on_payorder、on_region、on_role、on_role_user、on_seller_pledge、on_share、on_special_auction、on_verify_email、on_verify_mobile、on_weiurl的数据
# Time: 2016-08-02 16:54:39
# -----------------------------------------------------------
# 当前SQL卷标：#1
# -----------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='拍卖表' ;
...
CREATE TABLE `on_goods_category` (
  ...
  PRIMARY KEY (`cid`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品分类表' ;
...
CREATE TABLE `on_goods_order` (
  ...
  `time4` int(11) NOT NULL COMMENT '订单过期扣除保证金时间',
  `time5` int(10) NOT NULL COMMENT '评价卖家时间',
  `time6` int(10) NOT NULL COMMENT '申请退货时间',
  `time7` int(10) NOT NULL COMMENT '同意退货时间',
  `time8` int(10) NOT NULL COMMENT '不同意退货时间',
  `time9` int(10) NOT NULL COMMENT '买家发货时间',
  `time10` int(10) NOT NULL COMMENT '卖家确认收货时间',
...
CREATE TABLE `on_member` (
  ...
  `login_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1微信登录0账号登录',
  PRIMARY KEY (`uid`),
  KEY `account` (`account`),
  KEY `email` (`email`),
  KEY `account_2` (`account`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='网站前台会员表' ;
...
CREATE TABLE `on_member_limsum_bill` (
  ...
  `annotation` varchar(255) DEFAULT NULL COMMENT '记录操作说明',
...
CREATE TABLE `on_mysms` (
  ...
  KEY `time` (`time`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户消息提醒' ;
...
CREATE TABLE `on_node` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COMMENT='权限节点表' ;
...
CREATE TABLE `on_seller_pledge` (
  ...
  KEY `type` (`type`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商家保证金表' ;
...
CREATE TABLE `on_special_auction` (
  ...
  PRIMARY KEY (`sid`),
  KEY `sid` (`sid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='专场表' ;
...
# 数据库表：on_admin 数据信息
INSERT INTO `on_admin` VALUES ('1','超级管理员','super@oncoo.net','7f95b247ad70a4fa6a6347b20c76e2fa','1','我是超级管理员 哈哈~~','','1427592341');
INSERT INTO `on_admin` VALUES ('10','admin','admin@oncoo.net','66c52a6f236dd8b580b93a472d5b1b96','1','昂酷拍卖测试用户专用账号','','1428369452');
...
INSERT INTO `on_auction` VALUES ('1','1','0','0','M1-1470014093','0','0','0.00','20.00','0','0','阿喀琉斯将的卡拉斯经典款拉萨的','2000.00','2000.00','2000.00','1470014040','1472174040','1','1','fixation','ratio','20.00','50.00','120','300','0','0','0.00','0','0','1','0','0');
...
INSERT INTO `on_deliver_address` VALUES ('1','1','17','193','1959','南蒲区高店社区（C区）14号楼','453400','侯占蛟','13803845077','0383-8888888','1');
...
INSERT INTO `on_feedback` VALUES ('1','撒地方的','4');
...
# 数据库表：on_goods 数据信息
INSERT INTO `on_goods` VALUES ('1','4','阿喀琉斯将的卡拉斯经典款拉萨的','1_2_3_4_5_6','','卡拉胶sd卡垃圾啊快圣诞节了','2000.00','<p>我是商品详情的默认值，每当发布商品时候我都会出现。你可以把我当成商品详情的模板，可以修改我达到快速发布的效果。</p><p>通常对于有网站商品有共同的商品参数或者内容的时候设置我可以快速发布商品！</p><p>如果不需要我，可以在登陆后台【商品管理】-》【扩展字段、默认值】中选择商品详情进行编辑！</p><p><img src=\"/Uploads//20160801/579ea24aeda89.jpg\" style=\"float:none;\" title=\"118011_214935009_2.jpg\"/></p><p><img src=\"/Uploads//20160801/579ea24c95c4b.jpg\" style=\"float:none;\" title=\"1263764_002348016_2.jpg\"/></p><p><img src=\"/Uploads//20160801/579ea24e7125f.jpg\" style=\"float:none;\" title=\"2531170_182750386890_2.jpg\"/></p><p><br/></p>','5','51','628','Goods/20160801/579ea255d05d9.jpg','1470014041','','1','');
INSERT INTO `on_goods` VALUES ('2','6','阿克苏交罚款辣椒水电费考虑将阿斯顿','8_19_24_35_45_52','','拉克丝极度疯狂拉萨将地方考虑','300.00','<p>我是商品详情的默认值，每当发布商品时候我都会出现。你可以把我当成商品详情的模板，可以修改我达到快速发布的效果。</p><p>通常对于有网站商品有共同的商品参数或者内容的时候设置我可以快速发布商品！</p><p>如果不需要我，可以在登陆后台【商品管理】-》【扩展字段、默认值】中选择商品详情进行编辑！<br/></p>','5','50','621','Goods/20160801/579ea823321e0.jpg','1470015528','','1','');


# 数据库表：on_goods_category 数据信息
INSERT INTO `on_goods_category` VALUES ('1','0','二手车','','0','3');
INSERT INTO `on_goods_category` VALUES ('2','0','和田玉','','0','0');
...
INSERT INTO `on_goods_fields` VALUES ('1','&lt;table&gt;&lt;tbody&gt;&lt;tr class=&quot;firstRow&quot;&gt;&lt;td style=&quot;word-break: break-all;&quot; valign=&quot;top&quot; width=&quot;157&quot;&gt;阿斯顿发生地方&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td style=&quot;word-break: break-all;&quot; valign=&quot;top&quot; width=&quot;157&quot;&gt;阿斯顿发送到&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td style=&quot;word-break: break-all;&quot; valign=&quot;top&quot; width=&quot;157&quot;&gt;阿斯顿发生地方&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;td valign=&quot;top&quot; width=&quot;157&quot;&gt;&lt;br/&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/tbody&gt;&lt;/table&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;','35');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;阿斯顿广东省分行公司电费嘎斯的&lt;/p&gt;','35');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;爱的色放鬼地方丝瓜水地方噶&lt;br/&gt;&lt;/p&gt;','35');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;阿斯顿发送到4234234&lt;br/&gt;&lt;/p&gt;','34');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;234324阿斯蒂芬 234234&lt;br/&gt;&lt;/p&gt;','34');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;12312去玩儿去微博432&lt;br/&gt;&lt;/p&gt;','34');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','39');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','39');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','39');
INSERT INTO `on_goods_fields` VALUES ('1','','6');
INSERT INTO `on_goods_fields` VALUES ('2','','6');
INSERT INTO `on_goods_fields` VALUES ('3','','6');
INSERT INTO `on_goods_fields` VALUES ('1','','7');
INSERT INTO `on_goods_fields` VALUES ('2','','7');
INSERT INTO `on_goods_fields` VALUES ('3','','7');
INSERT INTO `on_goods_fields` VALUES ('1','','8');
INSERT INTO `on_goods_fields` VALUES ('2','','8');
INSERT INTO `on_goods_fields` VALUES ('3','','8');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;龙卷风绿壳蛋鸡艾丝凡两款撒娇地方&lt;/p&gt;','32');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;撒打发搜噶身份撒的发生的&lt;/p&gt;','32');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;阿斯顿噶收到法师打发斯蒂芬&lt;/p&gt;','32');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','40');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','40');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','40');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','41');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','41');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','41');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','42');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','42');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','42');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','43');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','43');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','43');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','44');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','44');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','44');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','45');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','45');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','45');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','46');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','46');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','46');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','47');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','47');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','47');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','48');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','48');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','48');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','49');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','49');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','49');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','50');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','50');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','50');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','51');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','51');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','51');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','52');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','52');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','52');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','53');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','53');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','53');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','54');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','54');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','54');
INSERT INTO `on_goods_fields` VALUES ('1','&lt;p&gt;我是扩展字段（1）这里是我的默认值，你可以编辑发布&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0028.gif\&quot;/&gt;&lt;/p&gt;','55');
INSERT INTO `on_goods_fields` VALUES ('2','&lt;p&gt;我是扩展字段（2），这是我的默认值，你可以编辑内容&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0040.gif\&quot;/&gt;&lt;/p&gt;','55');
INSERT INTO `on_goods_fields` VALUES ('3','&lt;p&gt;我是扩展字段（3），我是设置的默认值，你可以编辑我&lt;img src=\&quot;http://img.baidu.com/hi/jx2/j_0063.gif\&quot;/&gt;&lt;br/&gt;&lt;/p&gt;','55');
...
# 数据库表：on_member 数据信息
INSERT INTO `on_member` VALUES ('1','','','','houzhanjiao','oncoo','长垣昂酷网络有限公司','专注于拍卖系统的研发及销售！','96fc600ba51ffdcde25196b30a149981','侯占蛟','13803845077','1470012516','127.0.0.1','0','0','','','','User/579e9c728b658.jpg','','','','','0','0','0','','','','','','100000.00','400.00','0.00','0.00','0','0','192.168.1.238','1470127311','1','0');
...
INSERT INTO `on_member_pledge_bill` VALUES ('aad147001406149585','1','admin_deposit','1470014061','','100000.00','0.00');
INSERT INTO `on_member_pledge_bill` VALUES ('add147001409381917','1','add_freeze','1470014093','发布拍卖冻结保证金！','0.00','400.00');
...
# 数据库表：on_mysms 数据信息
INSERT INTO `on_mysms` VALUES ('1','1','0','0','0','0','系统发送','0','0','您好，后台管理员为您充值余额100000元！备注：','1470014061');
INSERT INTO `on_mysms` VALUES ('2','1','0','0','0','0','冻结提醒','0','0','系统冻结保证金400元备注：发布拍卖冻结','1470014093');
...
INSERT INTO `on_seller_pledge` VALUES ('1','1','1','proportion','400.00','0.00','1470014093','1');
...
INSERT INTO `on_special_auction` VALUES ('1','辣椒水的咖啡机阿喀琉斯点','','','将阿斯兰快递费将阿喀琉斯点','1470102120','1472175720','1','0','0','1');
