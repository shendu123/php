<?php if (!defined('THINK_PATH')) exit(); $__FOR_START_728__=0;$__FOR_END_728__=$layer;for($i=$__FOR_START_728__;$i < $__FOR_END_728__;$i+=1){ ?><select name="region[<?php echo ($name["$i"]); ?>]" id="<?php echo ($name["i"]); ?>" class="region valid">
