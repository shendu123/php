angular.module('auction.Admin.zhuanchang', [

]).controller('controller.auction.Admin.zhuanchang', ["$http", "$scope","$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "auction.Admin.zhuanchang", function($http, $scope, $rootScope, $stateParams, utils, $modal, Host, adminService) {
