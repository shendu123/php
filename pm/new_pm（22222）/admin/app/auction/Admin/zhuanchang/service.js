angular.module('auction.Admin.zhuanchang.service',[

]).service('auction.Admin.zhuanchang', [ "$http" , "API_WD_DOMAIN" ,function( $http , HOST){

    this.get = function(page, condition) {
        return $http({
            method: 'GET',
            url: HOST + '/auction/Admin/index/type/zhuanchang/page/'+page['currentPage']+'/pageSize/'+page['pageSize'],
            params: condition
        });
    };
