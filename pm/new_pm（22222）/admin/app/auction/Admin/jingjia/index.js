angular.module('auction.Admin.jingjia', [

]).controller('controller.auction.Admin.jingjia', ["$window","$http", "$scope","$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "auction.Admin.jingjia", function($window,$http, $scope, $rootScope, $stateParams, utils, $modal, Host, adminService) {
