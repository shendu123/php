angular.module('auction.Admin.jingjia.service',[

]).service('auction.Admin.jingjia', [ "$http" , "API_WD_DOMAIN" ,function( $http , HOST){

    this.get = function(page, condition) {
        return $http({
            method: 'GET',
            url: HOST + '/auction/Admin/index/type/jingjia/page/'+page['currentPage']+'/pageSize/'+page['pageSize'],
            params: condition
        });
    };
