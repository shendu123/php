angular.module('auction.Admin.paimai', [

]).controller('controller.auction.Admin.paimai', ["$window","$http", "$scope","$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "auction.Admin.paimai", function($window,$http, $scope, $rootScope, $stateParams, utils, $modal, Host, adminService) {
