angular.module('auction.Admin.vip', [

]).controller('controller.auction.Admin.vip', ["$http", "$scope","$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "auction.Admin.vip", function($http, $scope, $rootScope, $stateParams, utils, $modal, Host, adminService) {
