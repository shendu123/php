angular.module('pay.Order.auction', [

]).controller('controller.pay.Order.auction', [ "$http","$scope" ,"$rootScope" , "$stateParams", "utils", "$state", "API_WD_DOMAIN","pay.Order.auction", function($http,$scope, $rootScope, $stateParams, utils, $state, HOST,auctionService) {
