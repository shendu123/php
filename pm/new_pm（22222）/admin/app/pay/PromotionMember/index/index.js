angular.module('pay.PromotionMember.index', [

]).controller('controller.pay.PromotionMember.index', ["$http", "$scope", "$state", "$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "pay.PromotionMember.index", function($http, $scope, $state, $rootScope, $stateParams, utils, $modal, HOST, memberService) {
