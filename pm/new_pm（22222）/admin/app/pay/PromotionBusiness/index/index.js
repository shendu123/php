angular.module('pay.PromotionBusiness.index', [

]).controller('controller.pay.PromotionBusiness.index', ["$http", "$scope", "$state", "$rootScope", "$stateParams", "utils", '$modal', "API_WD_DOMAIN", "pay.PromotionBusiness.index", function($http, $scope, $state, $rootScope, $stateParams, utils, $modal, HOST, memberService) {
