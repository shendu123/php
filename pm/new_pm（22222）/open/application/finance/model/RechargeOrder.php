...
class RechargeOrder extends Model
{
    ...
    public function getList($wdata = array(), $exchange = true)
    {
        ...
        if(isset($wdata['order_status']) && !empty($wdata['order_status'])){
            $whereCond['order_status'] = $wdata['order_status'] == -1 ? 0 : $wdata['order_status'];
        }
		
		if(isset($wdata['order_pay_type']) && !empty($wdata['order_pay_type'])){
            $whereCond['order_pay_type'] = $wdata['order_pay_type'] == -1 ? 0 : $wdata['order_pay_type'];
        }
