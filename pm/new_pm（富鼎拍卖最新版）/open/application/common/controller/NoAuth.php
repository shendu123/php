    ...
    public function getCallerInfo($user_id_param = 0)
    {
        ...
        if(!empty($accesstoken)){
            if (! empty(Session::get($accesstoken))) {
                ...
                $data = curl_get_content("http://api.wode-mall.com/basic/Util/getUserInfoB", 0, "", $accesstoken);
            ...
            $data = curl_get_content("http://api.wode-mall.com/basic/Util/getUserInfoByUid?user_id={$user_id}");
            $data = object_array($data);
