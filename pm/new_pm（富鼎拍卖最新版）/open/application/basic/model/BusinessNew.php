...
class BusinessNew extends Model {
	...
	public function add($data,$user){	
		...
		Db::startTrans();		
		try{
			$business_id=Db::name('Business')->insertGetId($data['business']);
			$data['member_rule']['business_id']=$data['member']['business_id']=$business_id;
			$data['member_rule']['member_id']=Db::name('Member')->insertGetId($data['member']);
	...
	public function FormHandle($data,$user,$method = 'add'){
		...
		return ['member'=>$mData,'member_rule'=>$mruleData,'business'=>$data];
	}
