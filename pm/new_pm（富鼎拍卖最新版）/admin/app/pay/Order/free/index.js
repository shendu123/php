angular.module('pay.Order.free', [

]).controller('controller.pay.Order.free', [ "$http","$scope" ,"$rootScope" , "$stateParams", "utils", "$state", "API_WD_DOMAIN","pay.Order.free", function($http, $scope, $rootScope, $stateParams, utils, $state, HOST,freeService) {
    $scope.freeService = freeService;
    $scope.utils = utils;
