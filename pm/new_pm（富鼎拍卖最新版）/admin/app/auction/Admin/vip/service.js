angular.module('auction.Admin.vip.service',[

]).service('auction.Admin.vip', [ "$http" , "API_WD_DOMAIN" ,function( $http , HOST){

    this.get = function(page, condition) {
        return $http({
            method: 'GET',
            url: HOST + '/auction/Admin/index/type/vip/page/'+page['currentPage']+'/pageSize/'+page['pageSize'],
            params: condition
        });
    };
