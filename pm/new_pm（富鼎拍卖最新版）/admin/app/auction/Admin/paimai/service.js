angular.module('auction.Admin.paimai.service',[

]).service('auction.Admin.paimai', [ "$http" , "API_WD_DOMAIN" ,function( $http , HOST){

    this.get = function(page, condition) {
        return $http({
            method: 'GET',
            url: HOST + '/auction/Admin/index/type/paimai/page/'+page['currentPage']+'/pageSize/'+page['pageSize'],
            params: condition
        });
    };
