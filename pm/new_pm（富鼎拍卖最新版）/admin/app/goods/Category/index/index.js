        ...
        categoryService.get().success(function( res ){
            ...
            treeRender.renderTable( res  , null  , function(  item , icon ){
                ...
                return  '<div class="table-list-inner">' +
                    ...
                    '<div class="table-list-col col-xs-3 text-left tree-node">'+ icon + '&nbsp;&nbsp;' + item.cat_name  + ' </div>' +
                    ...
                    '<div class="table-list-col col-xs-1"><input class="form-control" style="width:50px;" type="text" value="'+ item.cat_sort +'" ng-blur="changeSort('+ item.id +',$event)"></div>' +
                    '<div class="table-list-col col-xs-1"> <span class="checkbox-wrap"><input ng-click="show('+item.id+',$event)" type="checkbox" '+ (item.is_show==1? 'checked="checked"'  : '') +' class="checkbox-slide" ng-true-value="1" ng-false-value="0"  data-id="'+ item.id +'" /><label></label></span></div>' +
                    ...
                    '<button class="btn btn-danger btn-xs glyphicon glyphicon-remove-circle" ></button>' +
                    '</div>' +
                    '</div>' +
                    '<div class="row">' +
