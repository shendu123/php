    ...
    angular.module("template/datepicker/popup.html", []).run(["$templateCache",
        function (a) {
            a.put("template/datepicker/popup.html",
                ...
                '<tr> ' +
                '<td  class="form-group" > ' +
                '<input type="text" ng-model="hours" class="form-control text-center " style="width:100%"  ng-mousewheel="incrementHours($event)" ng-readonly="true" maxlength="2"> ' +
                '</td> ' +
                '<td>:</td> ' +
                '<td class="form-group"> ' +
                '<input type="text" ng-model="minutes" class="form-control text-center "  style="width:100%"  ng-readonly="true" maxlength="2"> ' +
                '</td> ' +
                '<td>:</td> ' +
                '<td class="form-group"> ' +
                '<input type="text" ng-model="second" class="form-control text-center "  style="width:100%"  ng-readonly="true" maxlength="2"> ' +
                '</td> ' +
                '</tr> ' +
                    ...
                    if (typeof UE != "undefined") {
                        if (at.ueditor == "article") {
                            ed = new UE.ui.Editor({
                                ...
                                toolbars: [
                                    ["undo", "redo", "insertunorderedlist", "insertorderedlist", "cleardoc", "selectall", "print", "drafts", "simpleupload", "date", "time", "map", "horizontal", "spechars", "blockquote", "pasteplain", "insertcode", "template", "background", "bold", "italic", "underline", "fontborder", "strikethrough", "forecolor", "backcolor", "superscript", "subscript", "justifyleft", "justifycenter", "justifyright", "justifyjustify", "touppercase", "tolowercase", "directionalityltr", "directionalityrtl", "indent", "removeformat", "formatmatch", "autotypeset", "customstyle", "paragraph", "rowspacingbottom", "rowspacingtop", "lineheight", "fontfamily", "fontsize", "imagenone", "imageleft", "imageright", "imagecenter", "inserttable", "deletetable", "mergeright", "mergedown", "splittorows", "splittocols", "splittocells", "mergecells", "insertcol", "insertrow", "deletecol", "deleterow", "insertparagraphbeforetable", "fullscreen", "source"]
                                ],
                                initialFrameHeight: sp.height || 300,
                            ...
                            ed = new UE.ui.Editor({
                                ...
                                initialContent: _initContent,
                                toolbars: [
                                    ["source", "undo", "redo", "bold", "italic", "removeformat", "formatmatch", "autotypeset", "blockquote", "pasteplain", "|", "forecolor", "backcolor", "insertorderedlist", "insertunorderedlist", "simpleupload"]
                                ],
                                initialFrameHeight: sp.height || 300,
                                autoHeightEnabled: false,
                                wordCount: false,
        ...
        function (e, t, i, n, a, r, o, s, l) {
            return {
                ...
                link: function (a, d, c) {
                    ...
                    delete p.currentPage, true && (a[c.seniorTable].get({
