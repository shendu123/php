...
$.formValidator = 
{
	...
	sustainType : function(elem,validateType)
	{
		...
		switch(validateType)
		{
			...
			case "ajaxValidator":
				return (stype == "text" || stype == "number" || stype == "textarea" || stype == "file" || stype == "password" || stype == "select-one");
			case "regexValidator":
				return ((srcTag == "INPUT" || srcTag == "TEXTAREA") ? (stype != "checkbox" && stype != "radio") : false);
	...
	setTipState : function(elem,showclass,showmsg)
	{
		...
		else
		{
			...
			var stype = elem.type;
			if(stype == "password" || stype == "text" || stype == "number" || stype == "file")
			{
				jqobj = $(elem);
...
$.fn.formValidator = function(cs) 
{
	...
	return this.each(function(e)
	{
		...
		var isInputControl = stype == "password" || stype == "text" || stype == "number" || stype == "textarea";
